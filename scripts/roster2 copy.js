...
// -------------------------------
// Save localStorage data to Google Drive
// -------------------------------
async function overwriteFile() {
    try {
        // ✅ Get token from sessionStorage (set by cover.html)
...
async function logoutDrive() {
    try {
        ...
        // Revoke token using Google Identity API
        google.accounts.oauth2.revoke(accessToken, () => {
            ...
            localStorage.removeItem("gdrive_token"); // optional if you used it
